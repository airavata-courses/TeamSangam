            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                for (int _i147 = 0; _i147 < _set145.size; ++_i147)
                {
                  ...
                  _elem146 = edu.sga.sangam.auroraclient.sdk.ScheduleStatus.findByValue(iprot.readI32());
      ...
      if (incoming.get(4)) {
        {
          ...
          for (int _i172 = 0; _i172 < _set170.size; ++_i172)
          {
            ...
            _elem171 = edu.sga.sangam.auroraclient.sdk.ScheduleStatus.findByValue(iprot.readI32());
