            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                {
                  _elem247 = edu.sga.sangam.auroraclient.sdk.JobUpdateStatus.findByValue(iprot.readI32());
      ...
      if (incoming.get(4)) {
        {
          ...
          {
            _elem252 = edu.sga.sangam.auroraclient.sdk.JobUpdateStatus.findByValue(iprot.readI32());
